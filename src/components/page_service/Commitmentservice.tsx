...
import "./style/Commitmentservice.css"
...
const Commitmentservice: React.FC = () => {
    ...
    return (
        <>
        <div className='title-top_servise'>Check out our list of service for your garden and get free quote</div>
        <div className="commitment-sections">
            {/* Left Image Section */}
            <section className="commitment-content-l">
                <img src='/image/moun.jpg' alt='Gardening project' />
            </section>
